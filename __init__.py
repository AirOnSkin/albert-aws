...
AWS_SERVICES_LIST = [
    # management
    { "name": "AWS Account Portal", "url": "https://d-936700e7c9.awsapps.com/start#/" },
    ...
    { "name": "AWS Elastic Beanstalk", "url": "https://{0}.console.aws.amazon.com/elasticbeanstalk/home?region={0}#/environments".format(AWS_REGION) },
    { "name": "AWS Batch", "url": "https://{0}.console.aws.amazon.com/batch/home?region={0}".format(AWS_REGION) },
    { "name": "AWS ECS", "url": "https://{0}.console.aws.amazon.com/ecs/v2/clusters?region={0}".format(AWS_REGION) },
    { "name": "AWS Lambda", "url": "https://{0}.console.aws.amazon.com/lambda/home?region={0}#/discover".format(AWS_REGION) },
    ...
    { "name": "AWS Route53", "url": "https://us-east-1.console.aws.amazon.com/route53/v2/home#Dashboard" },
    ...
    { "name": "AWS CloudWatch", "url": "https://{0}.console.aws.amazon.com/cloudwatch/home?region={0}#home:".format(AWS_REGION) },
